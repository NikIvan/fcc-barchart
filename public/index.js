(() => {
  ...
  async function app() {
    ...
    console.log(data);
    const svg = select_default2("#chart").append("svg").attr("width", width + 100).attr("height", height + 60);
    select_default2(".container").selectAll("div").data(data.data).enter().append("div").style("background-color", color2).style("height", (d) => `${d[1]}px`).style("width", "5px").style("display", "inline-block").style("margin-left", (d, i) => i * 4);
  }
})();
